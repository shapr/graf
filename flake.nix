  ...
  outputs = {
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [
          ...
          "aarch64-darwin"
            ...
            graf = craneLib.buildPackage (craneCommon
              // {
    ...
    in {
      checks = forAllSystems ({
        ...
        graf-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        graf-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        graf-audit = craneLib.cargoAudit {
      ...
      apps = forAllSystems ({system, ...}: {
        graf = {
          type = "app";
          program = "${self.packages.${system}.graf}/bin/graf";
        };
        default = self.apps.${system}.graf;
      });
